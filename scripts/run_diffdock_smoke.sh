...
RAW_ROOT="${PDBBIND_RAW_ROOT:-data/raw/pdbbind}"
...
Expected files:
  data/raw/pdbbind/${SMOKE_COMPLEX_ID}/protein.pdb
  data/raw/pdbbind/${SMOKE_COMPLEX_ID}/ligand.sdf
  data/raw/pdbbind/${SMOKE_COMPLEX_ID}/ligand_gt.sdf
...
build_and_save_manifest(
    ids_path=split_path,
    raw_root=Path(os.environ.get("PDBBIND_RAW_ROOT", "data/raw/pdbbind")),
    split="smoke",
